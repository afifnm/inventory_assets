			...
			<div class="col-span-3 md:col-span-3">
				<div class="grid grid-cols-2 md:grid-cols-5 sm:grid-cols-1 gap-2 mt-5">
					<div class="box p-5 cursor-pointer zoom-in">
						<a href="<?php echo site_url('home/jenis/0');?>">
					...
					<div class="box p-5 cursor-pointer zoom-in">
						<a href="<?php echo site_url('home/jenis/'.$key['id_jenis']);?>">
							<div class="font-medium text-base"><?php echo $key['jenis']; ?> </div>
							<div class="text-gray-600"><?= $this->Aset_model->count_jenis_aset($key['id_jenis']); ?>
								aset</div>
						</a>
					</div>
					<?php } ?>
				...
				<div class="grid grid-cols-2 md:grid-cols-5 sm:grid-cols-1 gap-2 mt-5">
					<div class="box p-5 cursor-pointer zoom-in">
						<a href="<?php echo site_url('home/ruang/0');?>">
					...
					<div class="box p-5 cursor-pointer zoom-in">
						<a href="<?php echo site_url('home/ruang/'.$key['id_ruang']);?>">
							<div class="font-medium text-base"><?php echo $key['ruang']; ?> </div>
							<div class="text-gray-600"><?= $this->Aset_model->count_ruang_aset($key['id_ruang']); ?>
								aset</div>
						</a>
					</div>
					<?php } ?>
